...
class IntroScreen extends StatelessWidget {
  ...
  final List<PageViewModel> pages = [
    PageViewModel(
      ...
      body: 'Notes Manager est dans un premier temps une application de Consultation des notes des Etudiants conçus par les Etudiants de ICT4D. ',
     /* footer: SizedBox(
        height: 45,
        width: 300,
    ...
    PageViewModel(
        ...
        body: 'Ici, vous avez accès à toutes vos notes en fonction des Unitées d\'enseignement ainsi que votre Mgp',
       /* footer: SizedBox(
          height: 45,
          width: 300,
          child: ElevatedButton(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Notes Managers'),
        centerTitle: true,
      ),
      body: Padding(
